...
public class BasicManageFrame
{
	...
	JFrame frame =new JFrame("基本信息");
	private JButton btnNewButton;
	private JButton btnNewButton_1;
	private JButton btnNewButton_2;
	
	public BasicManageFrame()
	{
...
//			System.out.println(data);
		...
		scrollPane.setBounds(0, 0, 521, 140);
		...
		btnNewButton_1.addActionListener(new ActionListener()
		{
			...
			{
				try {
					int result=JOptionPane.showConfirmDialog(frame, "确定删除该老人的信息？","提示",JOptionPane.YES_NO_OPTION);
					if(result==JOptionPane.YES_OPTION)
					{
						int selectedRow=Table.getSelectedRow();
						//在数据库中删除这条数据
						String oldNo=(String) model.getValueAt(selectedRow, 1);
						String sql="delete from JiBenXinXi where name='"+oldNo+"'";
		...
		{	
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					BasicEditorFrame stayeditorFrame=new BasicEditorFrame(Table.getSelectedRow(),model);
				}catch(Exception e){
		...
		{	
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
			BasicAddFrame stayaddFrame=new BasicAddFrame();
			}
		});
	}
}