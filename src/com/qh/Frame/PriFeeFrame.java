...
public class PriFeeFrame
{
	...
	JFrame frame =new JFrame("个人收费信息查询");
	...
	public PriFeeFrame()
	{
		...
		//获取所有老人信息
		try {
			String sql="select * from Feedetail where name='厉致诚';";
...
//			System.out.println(data);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				PriFeeFrame.this.Table.setVisible(true);
			}
		});
